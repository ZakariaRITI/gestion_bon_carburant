    ...
    <div id="d1">
        ...
        <div class="main-container">
            <div class="container">
                ...
                <!-- Card principale -->
                <div class="sites-card fade-in">
                    <!-- Header -->
                    <div class="card-header">
                        <h1 class="page-title">📍 Liste des Sites</h1>
                        <p class="page-subtitle">Gérez tous vos sites en un seul endroit</p>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Bouton d'ajout -->
                        <a href="/as" class="add-btn">Ajouter un nouveau site</a>
                        ...
                        <table class="modern-table">
                            ...
                            <tbody>
                                ...
                                <tr class="table-row-animate" style="animation-delay: {{ $index * 0.1 }}s;">
                                    <td>
                                        <span class="code-site">{{$site->code_site}}</span>
                                    </td>
                                    <td>
                                        <span class="site-name">{{$site->nom_site}}</span>
                                    </td>
                                    <td>
                                        <a href="/updatesite?id={{$site->id}}" class="action-btn btn-update">
                                            Modifier
                                        </a>
                                    </td>
                                    <td>
                                        <a href="/deletesite?id={{$site->id}}" class="action-btn btn-delete">
                                            Supprimer
                                        </a>
                                    </td>
                                </tr>
