...
<body>
    ...
    <div class="container" style="margin-left:200px;">
        ...
        <h1 class="h1 text-center mb-4 fw-bold" style="color:#0f172a; text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">
            Recherche par n°Matricule du preneur
        </h1>
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="get" class="d-flex gap-2" style="max-width: 400px; width: 100%;">
                <input 
                    ...
                    name="motcle" 
                    id="s" 
                    placeholder="Entrez le n° matricule" 
        ...
        @if($bons->isNotEmpty())
        <h1 class="h1 fw-bold text-center">Liste de consommation de carburant par n°matricule</h1> <br>
        ...
        @elseif(!empty($motcle))
        <p class="text-center text-danger fw-bold">Le n°matricule saisi n'est pas disponible</p>
        @endif
    </div>
