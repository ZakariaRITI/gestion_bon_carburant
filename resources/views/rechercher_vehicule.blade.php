...
<body>
    ...
    @if($bons->isNotEmpty())
    <h1 class="h1 fw-bold text-center">Liste de consomation de caburant par n°vehicule</h1>
        ...
        @elseif(!empty($motcle))
        <p class="text-center text-danger fw-bold">le N°Vehicule saisis n'est pas disponible</p>
        @endif
</body>
</html>