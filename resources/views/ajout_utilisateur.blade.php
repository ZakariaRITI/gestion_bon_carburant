            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                     <form action="/ajservice" method="post" class="p-4 border rounded shadow" id="form">
                        ...
                        <input type="text" id="ns" name="email" class="form-control" value="{{ old('email') }}">
                        </div>
                        <div class="mb-3">
                        <label for="ns" class="form-label">Password :</label>
                        <input type="password" id="ns" name="password" class="form-control" value="{{ old('password') }}">
                        </div>
                        <div class="mb-3">
