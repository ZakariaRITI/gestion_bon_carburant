...
<head>
    ...
    <style>
        ...
        /* Code service avec style spécial */
        .code-service {
        ...
        /* Hover effects pour la table entière */
        .modern-table:hover {
    ...
    <div id="d1">
        ...
        <div class="main-container">
            <div class="container">
                ...
                <!-- Card principale -->
                <div class="services-card fade-in">
                    <!-- Header -->
                    <div class="card-header">
                        <h1 class="page-title">⚙️ Liste des Services</h1>
                        <p class="page-subtitle">Organisez et gérez tous vos services efficacement</p>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Bouton d'ajout -->
                        <a href="/aservice" class="add-btn">Ajouter un nouveau service</a>
                        
                        <!-- Table moderne -->
                        <table class="modern-table">
                            <thead>
                                <tr>
                                    <th>🏷️ Code Service</th>
                                    <th>⚙️ Nom du Service</th>
                                    <th>✏️ Modifier</th>
                                    <th>🗑️ Supprimer</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="table-row-animate" style="animation-delay: {{ $index * 0.1 }}s;">
                                    <td>
                                        <span class="code-service">{{$service->code_service}}</span>
                                    </td>
                                    <td>
                                        <span class="service-name">{{$service->nom_service}}</span>
                                    </td>
                                    <td>
                                        <a href="/updateservice?id={{$service->id}}" class="action-btn btn-update">
                                            Modifier
                                        </a>
                                    </td>
                                    <td>
                                        <a href="/deleteservice?id={{$service->id}}" class="action-btn btn-delete">
                                            Supprimer
                                        </a>
                                    </td>
                                </tr>
